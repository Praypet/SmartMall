  ...
  <div class="prodetail">
    ...
    <div class="comment">
      <div class="comment-title">
        <div class="left">商品评价 ({{commentsNum}}条)</div>
    ...
    <div class="footer">
      ...
      <div  class="btn-add" @click="addgoods">加入购物车</div>
      <div  class="btn-buy" @click="buygoods">立刻购买</div>
    </div>
    ...
    <van-action-sheet v-model="showPannel" :title="mode">
      <div class="product">
        <div class="product-title">
          <div class="left">
            <img alt="" :src="detail.goods_image">
          </div>
          <div class="right">
            <div class="price">
              <span>¥</span>
        ...
        <div class="num-box">
          ...
          <CountBox v-model="count" :stock="detail.stock_total"></CountBox>
        </div>
